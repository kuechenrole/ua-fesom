...
Ua_path='/work/ollie/orichter/MisomipPlus/ua/RG47911/ResultsFiles/0205800-Nodes7965-Ele15681-Tri3-kH1000-MismipPlus-ice1rr_t.mat';
load(Ua_path);
x_in_old = MUA.coordinates(:,1);
y_in_old = MUA.coordinates(:,2);
shelf_in_old = F.b;
shelf_old = griddata(x_in_old,y_in_old,shelf_in_old,x_out,y_out,'linear');

d2m = 111000;
ii = (x_out>4.45*d2m) & (x_out<=4.55*d2m) & (y_out>0.10*d2m) & (y_out<=0.16*d2m) ;
shelf(ii) = shelf_old(ii);



Ua_path='/work/ollie/orichter/MisomipPlus/ua/RG47911/ResultsFiles/0205900-Nodes7948-Ele15646-Tri3-kH1000-MismipPlus-ice1rr_t.mat';
load(Ua_path);
