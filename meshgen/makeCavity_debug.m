...
if contains(id,'ir')
    meshpath='/home/csys/orichter/IsomipPlus/z-mesh/ice_removed/';
elseif contains(id,'br')
    meshpath=meshOutPath;%'/work/ollie/orichter/MisomipPlus/fesom_mesh/010/';
else
    meshpath='/home/csys/orichter/IsomipPlus/z-mesh/nothing_removed/';
end
...
for i=1:n2d
     ...
     if (xcoord(i)>4.45) & (xcoord(i)<=4.55) & (ycoord(i)>0.10) & (ycoord(i)<=0.16)
         nodes3(5,n)=20
     end
